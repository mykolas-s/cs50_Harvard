...
$(document).ready(function() {
    ...
    let options = {
        center: { lat: 39.4236, lng: -100.1619 },
...
function addMarker(place) {
    ...
    google.maps.event.addListener(marker, "click", function() {
        ...
        $.getJSON("/articles", { geo: place["postal_code"] }, function(data, textStatus, jqXHR) {
            ...
            // build list of links to articles --> remember how we retrieved JSON object
            var content = '<ul>';
    ...
    // remember marker: make list of markers (we will want iterate though it later in removeMarker())
    markers.push(marker);
}
